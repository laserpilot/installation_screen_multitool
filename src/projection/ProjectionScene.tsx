...
export function ProjectionScene() {
  ...
  const camX = -(Math.max(8, metrics.widthFt) + 4);
    ...
    <div className="proj-stage">
      <div className="proj-frame">
        ...
        >
          ...
          />
          <Text
            position={[halfW + 1.9, 0.03, distFt / 2]}
      ...
      <div className="proj-readout">
        ...
        <dl className="dvled-metrics">
          <div>
            <dt>Image size</dt>
            <dd>
              {metrics.widthFt.toFixed(1)} × {metrics.heightFt.toFixed(1)} ft
            </dd>
          </div>
          <div>
            <dt>Area</dt>
            <dd>{Math.round(metrics.areaSqFt)} ft²</dd>
          </div>
          <div>
            <dt>Brightness</dt>
          ...
          <div>
            <dt>Resolution / ft</dt>
            <dd>
              {Math.round(metrics.hPpf)} × {Math.round(metrics.vPpf)} px
            </dd>
          </div>
          <div>
            <dt>Total output</dt>
            <dd>{metrics.effectiveLumens.toLocaleString()} lm</dd>
          </div>
        </dl>
